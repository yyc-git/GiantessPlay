...
export let backTwoHands: actionNodeFunc = (state, id) => {
    Console.log("backTwoHands")

    return triggerAction(state, actionName.BackTwoHands as any, id, Girl.triggerAction, getKey())
}