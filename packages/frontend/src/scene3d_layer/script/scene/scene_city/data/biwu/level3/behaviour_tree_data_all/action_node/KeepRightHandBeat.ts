...
export let keepRightHandBeat: actionNodeFunc = (state, id) => {
    Console.log("keepRightHandBeat")

    return triggerAction(state, actionName.KeepRightHandBeat as any).then(([state, result_]) => {
