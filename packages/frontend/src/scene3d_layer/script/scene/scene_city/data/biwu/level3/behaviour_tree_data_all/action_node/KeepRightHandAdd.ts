...
export let keepRightHandAdd: actionNodeFunc = (state, id) => {
    Console.log("keepRightHandAdd")

    return triggerAction(state, actionName.KeepRightHandAdd as any).then(([state, result_]) => {
