...
import * as Protect from "./action_node/Protect"
...
export let buildActionNode = (node: BehaviourTreeData.actionNode): nullable<actionNodeFromState> => {
    switch (node) {
        ...
        case BehaviourTreeData.actionNode.Protect:
            return NullableUtils.return_(
                BehaviourTreeManager.wrapActionNode(Protect.protect, generateId())
            )
