...
export let keepTwoHandsBeat: actionNodeFunc = (state, id) => {
    Console.log("keepTwoHandsBeat")

    return triggerAction(state, actionName.KeepTwoHandsBeat as any).then(([state, result_]) => {
