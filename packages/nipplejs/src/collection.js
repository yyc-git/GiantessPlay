...
import * as LandscapeUtils from "meta3d-utils/src/LandscapeUtils";
...
Collection.prototype.createNipple = function (position, identifier) {
    ...
    if (position.x && position.y) {
        ...
        var dumbBox = LandscapeUtils.getBoundingClientRect(dumb.getBoundingClientRect())
...
Collection.prototype.updateBox = function () {
    ...
    self.box = LandscapeUtils.getBoundingClientRect(self.options.zone.getBoundingClientRect())
};
...
Collection.prototype.processOnStart = function (evt) {
    ...
    // };
    var position = {
        x: LandscapeUtils.getPageX(evt),
        y: LandscapeUtils.getPageY(evt)
    };
...
Collection.prototype.processOnMove = function (evt) {
    ...
    if (opts.dynamicPage) {
        ...
        var elBox = LandscapeUtils.getBoundingClientRect(nipple.el.getBoundingClientRect())
