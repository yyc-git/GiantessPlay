import { id, missileVehicleMissileEmitter, missileVehicleMissileEmitterParam, missileVehicleMissileParticle, state } from "../../type/StateType"
...
let _getState = (state: state): missileVehicleMissileEmitter => {
    return getExn(getParticleState(state).missileVehicleMissileEmitter)
}

let _setState = (state: state, missileVehicleMissileEmitterState: missileVehicleMissileEmitter) => {
    return {
        ...state,
        particle: {
            ...getParticleState(state),
            missileVehicleMissileEmitter: return_(missileVehicleMissileEmitterState)
        }
    }
}
